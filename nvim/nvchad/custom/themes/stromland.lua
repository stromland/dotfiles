...
M.base_30 = {
  white = "#DCDFE4",
  darker_black = "#202032",
  black = "#272932", --  nvim bg
  black2 = "#272032",
  one_bg = "#404352",
  one_bg2 = "#404352", -- StatusBar (filename)
  one_bg3 = "#404352",
  grey = "#2d385b", -- Line numbers (shouldn't be base01?)
  ...
  orange = "#E5C07B",
  cyan = "#56B6C2",
  statusline_bg = "#272932",
  lightbg = "#404352",
  pmenu_bg = "#272932", -- Command bar suggestions
  folder_bg = "#61AFEF",
}
...
M.base_16 = {
  ...
  base03 = "#98C379", -- Comments, invisibles, line hl
